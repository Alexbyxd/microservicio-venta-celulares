...
const registerSchema = z.object({
  ...
  pictureUrl: z.string().url("URL inválida").optional().or(z.literal("")),
});
...
export function RegisterModal({ children, open: externalOpen, onOpenChange: externalOnOpenChange }: RegisterModalProps) {
  const { login } = useAuth();
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[450px] border border-white/10 bg-black/60 px-8 py-10 backdrop-blur-2xl shadow-[0_0_40px_rgba(0,0,0,0.8)] overflow-hidden">
        <motion.div
        ...
        >
          <DialogHeader className="mb-6">
            ...
            <DialogDescription className="text-white/60 text-sm mt-2">
              Únete a nosotros. Crea tu cuenta para acceder a la plataforma.
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <FieldGroup className="gap-5">
              ...
              >
                <Field data-invalid={!!form.formState.errors.pictureUrl}>
                  <FieldLabel
                    htmlFor="pictureUrl"
                    className="text-white/80 font-medium"
                  >
                  ...
                  <Input
                    ...
                    aria-invalid={!!form.formState.errors.pictureUrl}
                    className="h-11 rounded-lg border-white/10 bg-white/5 px-4 text-white placeholder:text-white/30 focus-visible:ring-1 focus-visible:ring-white/30 focus-visible:border-white/30 focus-visible:bg-white/10 transition-all"
                    {...form.register("pictureUrl")}
                  />
                  <FieldError errors={[form.formState.errors.pictureUrl]} />
                </Field>
              </motion.div>
