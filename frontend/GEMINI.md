...
- **Creación de Páginas:** Usar obligatoriamente la skill en [.agents/skills/next-best-practices/SKILL.md](.agents/skills/next-best-practices/SKILL.md).
- **Desarrollo de UI:** Consultar [.agents/rules/ui.md](.agents/rules/ui.md) para el estilo visual y usar la skill `ui-ux-pro-max` para el acabado.
- **Ecosistema Shadcn UI:** Usar la skill en [.agents/skills/shadcn/SKILL.md](.agents/skills/shadcn/SKILL.md).
...
3. **Implementación:** Seguir las reglas de [.agents/rules/ui.md](.agents/rules/ui.md) para la interfaz.
4. **Validación:** El código debe pasar `npm run build` sin errores.

## Mantenimiento de la Fuente de Verdad

- Este archivo y sus complementos ([.agents/rules/ui.md](.agents/rules/ui.md), [.agents/rules/auth.md](.agents/rules/auth.md)) son la fuente de verdad.
