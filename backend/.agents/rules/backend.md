...
- **Expert Skill**: [nestjs-rabbitmq-microservices-expert](../.gemini/skills/nestjs-rabbitmq-microservices-expert/SKILL.md)
  _Este recurso contiene los patrones de arquitectura, configuración de RabbitMQ y manejo de excepciones específicos para este proyecto._

## 📌 Mapa de Contexto

Para detalles específicos, consulta los módulos especializados:
